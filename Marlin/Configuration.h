...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Autotune derived on 08 Jan 18 Cold Night
  #define  DEFAULT_bedKp 473.15
  #define  DEFAULT_bedKi 90.25
  #define  DEFAULT_bedKd 620.12
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 186, 186, 2195, 210.87 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
 // Make sure the Z feedrate is set to 4 or the Z axis will not limit and will miss steps.
...
// From internet in attempt to fix SD INIT failures
